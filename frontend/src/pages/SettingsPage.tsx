...
import { Save, Building2, CreditCard, Moon, Sun } from 'lucide-react'
            ...
            <form onSubmit={handleSubmit} className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden">
                    ...
                    <div className="grid grid-cols-2 gap-6">
                        ...
                        <div className="col-span-1">
                            ...
                            <input
                                ...
                                placeholder="0000"
                                className="w-full border rounded-lg px-3 py-2 bg-white dark:bg-slate-950 dark:border-slate-700 dark:text-white focus:ring-2 focus:ring-orange-500 outline-none transition-all"
                            />
                        ...
                        <div className="col-span-2">
                            ...
                            <input
                                name="numero_cuenta_cargo"
                                value={formData.numero_cuenta_cargo}
                                onChange={handleChange}
                                placeholder="ES00 0000 0000 00 0000000000"
                                className="w-full border rounded-lg px-3 py-2 font-mono bg-white dark:bg-slate-950 dark:border-slate-700 dark:text-white focus:ring-2 focus:ring-orange-500 outline-none transition-all"
                            />
                        </div>
                    </div>
                    ...
                    <div className="border-t border-slate-100 dark:border-slate-800 pt-6 grid grid-cols-2 gap-6">
                        ...
                        <div className="col-span-2">
                            ...
                            <input
                                ...
                                onChange={handleChange}
                                placeholder="Ej: C:\RemesasBanco"
                                className="w-full border rounded-lg px-3 py-2 bg-white dark:bg-slate-950 dark:border-slate-700 dark:text-white focus:ring-2 focus:ring-orange-500 outline-none transition-all font-mono text-sm"
                            />
                            <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">
                                Las remesas generadas se guardarán automáticamente en esta carpeta de tu ordenador, además de la descarga normal.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-slate-50 dark:bg-slate-800 px-6 py-4 flex justify-end">
                    <button
                        ...
                        className="bg-slate-900 dark:bg-slate-700 text-white px-6 py-2 rounded-lg font-medium hover:bg-slate-800 dark:hover:bg-slate-600 flex items-center gap-2 disabled:opacity-70"
                    >
